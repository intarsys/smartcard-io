 ...
 * 
 * This is created by {@link IPCSCContext#connect(String, String, int, int)}.
 * 
 */
public interface IPCSCConnection {
	...
	/**
	 * A name uniquely identifying the connection
	 * 
	 * @return
	 */
	public String getId();
	...
	/**
	 * Get some information about the connected reader
	 * 
	 * @throws PCSCException
	 */
